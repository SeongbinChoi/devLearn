...
public class Mentors {
	...
	public String getMentorSubject() {
		return mentorSubject;
	}
	public void setMentorSubject(String mentorSubject) {
	...
	public int getMentorPrice() {
		return mentorPrice;
	}
	public void setMentorPrice(int mentorPrice) {
