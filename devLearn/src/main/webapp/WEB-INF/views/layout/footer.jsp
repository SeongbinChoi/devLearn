		...
		<div class="applys">	
			<div class="card apply-card" >
				<div class="card-body">
					...
					<a href="#" class="btn btn-primary rounded-pill">강사 신청하기&nbsp;<i class="fa-solid fa-arrow-right"></i></a>
				</div>
			</div>
			<div class="card apply-card">
					<div class="card-body">
					...
					<a href="#" class="btn btn-primary rounded-pill">멘토 신청하기&nbsp;<i class="fa-solid fa-arrow-right"></i></a>
				</div>
			</div>
			<div class="card apply-card" >
					<div class="card-body">
					...
					<a href="#" class="btn btn-primary rounded-pill">스터디 구하기&nbsp;<i class="fa-solid fa-arrow-right"></i></a>
				</div>
			</div>
		</div>	
	</c:if>
